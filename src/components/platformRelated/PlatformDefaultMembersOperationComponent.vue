          ...
          :style="platformStyleObject" @click.stop="ignoreEmitHidden">
            <div class="platform-content">
              ...
              <div class="platform-body">
                ...
                <div class="sep-line-layout"></div>
                <ul class="ul-layout">
                  <li v-for="supplierItem in this.$store.state.supplierAndPurchaseModule.defaultGroupSupplierData" :key="supplierItem.id">
...
export default {
  ...
  methods: {
    onTotalSwitchChecked () {
      ...
      if (this.$store.state.supplierAndPurchaseModule.defaultGroupSupplierData.length === 0) {
        isTotalChecked = false
      }
      for (let index = 0; index < this.$store.state.supplierAndPurchaseModule.defaultGroupSupplierData.length; index++) {
        let element = this.$store.state.supplierAndPurchaseModule.defaultGroupSupplierData[index]
      ...
      if (isTotalChecked === true) {
        ...
        for (let index = 0; index < this.$store.state.supplierAndPurchaseModule.defaultGroupSupplierData.length; index++) {
          const element = this.$store.state.supplierAndPurchaseModule.defaultGroupSupplierData[index]
