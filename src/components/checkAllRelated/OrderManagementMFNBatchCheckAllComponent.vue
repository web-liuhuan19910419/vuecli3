...
export default {
  ...
  methods: {
    checkAllStatus () {
      ...
      for (let index = 0; index < this.$store.state.supplierAndPurchaseModule.mfnBatchDeliveryListData.length; index++) {
        let element = this.$store.state.supplierAndPurchaseModule.mfnBatchDeliveryListData[index]
