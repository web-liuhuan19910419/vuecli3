<template>
  <div class="grid-layout">
    <div>
      <table v-if="isColDynamicWidth" style="background-color: white;border:solid #ffffff;border-width:1px 1px 1px 1px;width: 100%;">
        <thead>
        <tr @click.stop="clickRowReset">
          ...
          <th v-for="action in actions" :key=action.name></th>
        </tr>
        </thead>
        <tbody>
          <tr
            ...
            <td v-for="(action, index) in actions" :key=action.name
              :class="[{'click-row-style' : mutiChoiceArr[rowIndex].checked}]"
      ...
      <table v-if="isDynamicColumnActions" style="background-color: white;border:solid #ffffff;border-width:1px 1px 1px 1px;width: 100%;word-break:break-all;table-layout:fixed;">
        <thead>
        <tr @click.stop="clickRowReset">
          <th width="3%"></th>
          <th v-for="(key, index) in titles" :key="key" v-html="processTitle(index)" :width="processWidths(index)" :style="{'text-align': 'left', 'padding-left': '10px', 'padding-right': '10px', 'cursor': 'pointer'}"  @click.stop="onSwitchSort(index)">
...
export default {
  ...
  created () {
    ...
    console.log(this.isDynamicColumnActions)
  },
  beforeMount () {
    console.log(this.actions)
    console.log(this.isDynamicColumnActions)
